(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("ece955a8-f933-48f7-a20c-58f7f120fabe");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'ece955a8-f933-48f7-a20c-58f7f120fabe' but no matching script tag was found.")
        }
